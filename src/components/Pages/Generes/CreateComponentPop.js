...
import { useContext } from "react";
 ...
 function CreateComponentPop({open2, children2, onClose2}){
    const createPopSongCardUrl = 'http://localhost:3001/pop';
    let {id} = useParams();
...
export default CreateComponentPop;